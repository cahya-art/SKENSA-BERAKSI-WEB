    ...
    <nav class="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-10 text-sm font-medium text-gray-500">
                <a href="{{ route('edukasi') }}" class="hover:text-[#2D5A7B] transition-colors border-b-2 border-teal-500 pb-1 text-[#2D5A7B]">Informasi</a>
                <a href="{{ route('ceritakan') }}" class="hover:text-[#2D5A7B] transition-colors">Ceritakan</a>
                <a href="{{ route('pengalaman') }}" class="hover:text-[#2D5A7B] transition-colors">Pengalaman</a>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 leading-relaxed">
                    Platform dukungan siswa untuk menciptakan lingkungan sekolah yang bebas perundungan, inklusif, dan saling mendukung.
                </p>
            </div>
            ...
            <div>
                ...
                <div class="flex gap-4">
                    <div class="w-10 h-10 bg-[#F0F7F7] rounded-full flex items-center justify-center text-[#2D5A7B]">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15h-2v-6h2v6zm-1-7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm5 7h-2v-6h2v6zm-1-7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z" /></svg>
                    </div>
                    <div class="w-10 h-10 bg-[#F0F7F7] rounded-full flex items-center justify-center text-[#2D5A7B]">
